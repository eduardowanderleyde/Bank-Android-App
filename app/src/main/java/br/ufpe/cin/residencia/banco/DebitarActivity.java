...
public class DebitarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Define o tipo de operação e texto do botão de acordo com a operação (Débito)
        ...
        btnOperacao.setOnClickListener(
                v -> {
                    ...
                    System.out.println("Teste debitar" + valor);

                    // Verificar se o valor e o indicie do spinner são maiores que zero
                    if(valor > 0 && positionOrigem > 0){
                        // Debitar o valor da conta de origem usando o ViewModel
